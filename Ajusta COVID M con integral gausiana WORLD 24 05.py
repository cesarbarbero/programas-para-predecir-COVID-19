...
largoexp=0
nombre_file='D:/MundoCA/WORLDJHU2805suma.csv'
DiadeInicio="January 22, 2020"

ini_date = datetime(2020,1,22)
pob_pais=7300 #poblacion canada
pais="WORLD"

# limits parameters
inibound= [1000,50.0,0,1e5 ]
endbound= [10000.0, 120.0, 100,1e6]
...
plt.legend()
nombre_archivo_png="D:/MundoCA/"+"WORLDcd.png"
...
plt.legend()
nombre_archivo_png="D:/MundoCA/"+"WORLDpdd.png"
plt.savefig(nombre_archivo_png)
plt.show()
...
plt.legend()
nombre_archivo_png="D:/MundoCA/"+"WORLDlsqPDD.png"
plt.savefig(nombre_archivo_png)
plt.show()
